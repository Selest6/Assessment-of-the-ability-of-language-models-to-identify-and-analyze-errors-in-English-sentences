...
headers = ['label', 'category', 'correction']
...
for sentence in tqdm(sentences):
    ...
    correction = "Nothing"
    category = "Nothing"
    while label == "Nothing" or correction == "Nothing" or category == "Nothing":
        try:
            time.sleep(8)
            ...
            category_match = re.search(r'Category:(.+?)Correct Sentence:', data)
    ...
    with open(filename, "a", encoding="utf-8") as file:
        file.write(f"{label}\t{category}\t{correction}\n")
